defmodule App.AccountsTest do
  ...
  describe "children" do
    ...
    @invalid_attrs %{date_of_birth: nil, medical_record_number: nil, name: nil}
    ...
    test "create_child/1 with valid data creates a child" do
      valid_attrs = %{date_of_birth: ~D[2025-04-21], medical_record_number: "some medical_record_number", name: "some name"}

      assert {:ok, %Child{} = child} = Accounts.create_child(valid_attrs)
      assert child.date_of_birth == ~D[2025-04-21]
      assert child.medical_record_number == "some medical_record_number"
    ...
    test "update_child/2 with valid data updates the child" do
      child = child_fixture()
      update_attrs = %{date_of_birth: ~D[2025-04-22], medical_record_number: "some updated medical_record_number", name: "some updated name"}

      assert {:ok, %Child{} = child} = Accounts.update_child(child, update_attrs)
      assert child.date_of_birth == ~D[2025-04-22]
      assert child.medical_record_number == "some updated medical_record_number"
